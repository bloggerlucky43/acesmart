...
export const EDUCATOR_PLANS = [
  ...
  {
    id: "institution",
    name: "Institution & CBT Center",
    badge: "High Performance",
    tagline: "Advanced security and biometric proctoring for large schools & UTME centers.",
    monthlyPrice: 60000,
    ...
    features: [
      ...
      "Unlimited published examinations",
      "AI Face Recognition & biometric candidate check-in",
      "Full 50,000+ past questions + Custom question builder",
      "Offline test room sync capability",
      "Comprehensive performance analytics & class rank",
      "Automated SMS/Email exam slip dispatch",
      "Dedicated account manager",
      "Custom domain support (school.acesmart.site)",
    ],
    limitations: [],
    ctaText: "Upgrade to Institution",
    disabled: false,
  },
  {
    id: "enterprise",
