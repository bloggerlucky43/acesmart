...
export const EditExamStructure = lazy(
  () => import("../components/teacher/exam/EditExamStructure"),
);
export const EditDraft = lazy(
  () => import("../components/teacher/exam/EditDraft"),
);
